...
##CONFIG DEFINATION###
config = {
    'CSV_PATH': '/content/sample_data/regression/linear_regression/linear_regression_500.csv',
    'SAVE_PATH': '/content/sample_data/regression/linear_regression/',
    'TARGET_COL' : 'y'
}
...
checkpoints = tf.keras.callbacks.ModelCheckpoint('best_linear_model.keras', save_best_only=True)
...
model.save(os.path.join(config['SAVE_PATH'], "linear_regression_model.keras"), save_format='keras')
