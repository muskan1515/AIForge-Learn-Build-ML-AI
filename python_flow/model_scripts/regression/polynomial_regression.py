...
##CONFIG DEFINATION###
config = {
    'CSV_PATH': '/content/sample_data/regression/polynomial_regression/polynomial_regression_500.csv',
    'SAVE_PATH': '/content/sample_data/regression/polynomial_regression/',
    'TARGET_COL' : 'x_squared'
}
...
checkpoints = tf.keras.callbacks.ModelCheckpoint('best_polynomial_model.keras', save_best_only=True)
...
model.save(os.path.join(config['SAVE_PATH'], "polynomial_regression_model.keras"), save_format='keras')
