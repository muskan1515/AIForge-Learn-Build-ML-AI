...
##CONFIG DEFINATION###
config = {
    'CSV_PATH': '/content/sample_data/classification/classification_dataset_10000_categorical.csv',
    'SAVE_PATH': '/content/sample_data/classification/',
    'TARGET_COL' : 'label'
}
...
checkpoints = tf.keras.callbacks.ModelCheckpoint('best_classification_model.keras', save_best_only=True)
...
model.save(os.path.join(config['SAVE_PATH'], "classification_model.keras"), save_format='keras')
